# Generated by Django 4.2 on 2023-08-29 14:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('O', 'A vérifier'), ('W', 'En attente de paiement'), ('E', 'Expiré'), ('P', 'Payée'), ('V', 'Payée et validée'), ('S', 'Payée mais problème de synchro cashless'), ('C', 'Annulée')], default='O', max_length=1, verbose_name='Statut de la commande')),
