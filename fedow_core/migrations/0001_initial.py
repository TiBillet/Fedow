# Generated by Django 4.2.8 on 2024-01-23 13:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('TLF', 'Token équivalent euro'), ('TNF', 'Non fiduciaire'), ('FED', 'Stripe Connect'), ('TIM', "Monnaie temps, decompte d'utilisation"), ('BDG', 'Badgeuse/Pointeuse'), ('SUB', 'Adhésion ou abonnement')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('O', 'En attente de paiement'), ('E', 'Expiré'), ('P', 'Payé'), ('W', 'Wallet primaire chargé'), ('V', 'Wallet user chargé'), ('C', 'Annulée'), ('R', 'en erreur')], default='O', max_length=1, verbose_name='Statut de la commande')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription_type', models.CharField(choices=[('NO', 'None'), ('YEA', 'Annuel'), ('CIV', 'Civil'), ('MON', 'Mensuel'), ('WEK', 'Hebdomadaire'), ('DAY', 'Journalier'), ('HOR', 'Horaire')], default='NO', max_length=3)),
                ...
                ('action', models.CharField(choices=[('FST', 'Premier bloc'), ('SAL', "Vente d'article"), ('CRE', 'Creation monétaire'), ('REF', 'Recharge'), ('TRF', 'Transfert'), ('SUB', 'Abonnement ou adhésion'), ('BDG', 'Badgeuse'), ('FUS', 'Fusion de deux wallets'), ('RFD', 'Remboursement'), ('VID', 'Dissocciation de la carte et du wallet user')], default='SAL', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dokos_id', models.CharField(blank=True, editable=False, max_length=100, null=True)),
