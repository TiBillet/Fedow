# Generated by Django 4.2 on 2023-11-17 16:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('F', 'Premier bloc'), ('S', "Vente d'article"), ('C', 'Creation monétaire'), ('R', 'Recharge'), ('T', 'Transfert'), ('M', 'Abonnement ou adhésion')], default='S', max_length=1)),
