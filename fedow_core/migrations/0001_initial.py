# Generated by Django 4.2.7 on 2023-12-15 12:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_check', models.DateTimeField(auto_now=True, null=True)),
                ('action', models.CharField(choices=[('FST', 'Premier bloc'), ('SAL', "Vente d'article"), ('CRE', 'Creation monétaire'), ('REF', 'Recharge'), ('TRF', 'Transfert'), ('MEM', 'Abonnement ou adhésion'), ('BDG', 'Badgeuse'), ('FUS', 'Fusion de deux wallets'), ('RFD', 'Remboursement'), ('VID', 'Dissocciation de la carte et du wallet user')], default='SAL', max_length=3)),
