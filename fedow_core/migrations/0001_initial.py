# Generated by Django 4.2 on 2023-08-25 19:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('private_rsa_key', models.CharField(editable=False, max_length=2048)),
                ('public_rsa_key', models.CharField(editable=False, max_length=512)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin', models.ManyToManyField(related_name='admin_places', to=settings.AUTH_USER_MODEL)),
