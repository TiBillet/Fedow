# Generated by Django 4.2 on 2023-08-13 16:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cashless_server_ip', django_cryptography.fields.encrypt(models.GenericIPAddressField(blank=True, editable=False, null=True))),
                ('cashless_server_url', django_cryptography.fields.encrypt(models.URLField(blank=True, editable=False, null=True))),
                ('cashless_server_key', django_cryptography.fields.encrypt(models.CharField(blank=True, editable=False, max_length=100, null=True))),
