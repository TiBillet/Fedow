# Generated by Django 4.2 on 2023-10-25 16:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('TLF', 'Fiduciary local token'), ('TNF', 'Token local non fiduciaire'), ('FED', 'Fiduciary and federated token on stripe'), ('MEM', 'Membership or subscription')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('F', 'Premier bloc'), ('S', "Vente d'article"), ('C', 'Creation monétaire'), ('R', 'Recharge'), ('T', 'Transfert')], default='S', max_length=1)),
