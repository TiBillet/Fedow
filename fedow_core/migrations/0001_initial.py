# Generated by Django 4.2 on 2023-09-13 13:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('F', 'Premier bloc'), ('S', "Vente d'article"), ('C', 'Creation monétaire'), ('R', 'Recharge Cashless'), ('T', 'Transfert')], default='S', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_cards_cashless', models.ManyToManyField(related_name='primary_cards_cashless', to='fedow_core.card')),
        ...
        migrations.AddField(
            model_name='card',
            name='origin',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='cards', to='fedow_core.origin'),
        ),
        migrations.AddField(
            model_name='card',
            name='user',
        ...
        migrations.AddField(
            model_name='asset',
            name='origin',
            field=models.OneToOneField(editable=False, help_text="Lieu ou configuration d'origine", on_delete=django.db.models.deletion.PROTECT, related_name='primary_asset', to='fedow_core.wallet'),
        ),
        migrations.AddField(
