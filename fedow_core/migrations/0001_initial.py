# Generated by Django 4.2 on 2023-10-12 16:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('TLF', 'Fiduciary local token'), ('TNF', 'Token local non fiduciaire'), ('FED', 'Fiduciary and federated token on stripe')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('complete_tag_id_uuid', models.UUIDField(blank=True, editable=False, null=True)),
                ('qrcode_uuid', models.UUIDField(editable=False)),
                ('number_printed', models.CharField(db_index=True, editable=False, max_length=8)),
            ],
        ),
        migrations.CreateModel(
            name='CheckoutStripe',
