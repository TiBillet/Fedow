# Generated by Django 4.2.8 on 2024-02-16 16:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='asset',
            name='category',
            field=models.CharField(choices=[('TLF', 'Token équivalent euro'), ('TNF', 'Non fiduciaire'), ('FED', 'Stripe Connect'), ('TIM', "Monnaie temps, decompte d'utilisation"), ('FID', 'Points de fidélité, non fiat.'), ('BDG', 'Badgeuse/Pointeuse'), ('SUB', 'Adhésion ou abonnement')], max_length=3),
        ),
    ]
